...
// Layouts
const Header = dynamic(() => import("@layouts/Header"), { suspense: true });
const Roadshow = dynamic(() => import("@layouts/Roadshow"), { suspense: true });
const Timelines = dynamic(() => import("@layouts/Timelines"), {
  suspense: true,
});
const Schedule = dynamic(() => import("@layouts/Schedule"), { suspense: true });
const MentorsSpeaker = dynamic(() => import("@layouts/MentorsSpeakers"), {
  suspense: true,
});
const Sponsor = dynamic(() => import("@layouts/Sponsor"), { suspense: true });
