...
export default function Home() {
  ...
  return (
    <>
      ...
      <nav
        className={`navbar flex items-center justify-center fixed inset-x-0 z-base ${
          scroll ? "active" : ""
        }`}
      >
        <div className="container">
          <div className="flex justify-between w-full">
            <Link href="/" passHref>
              <a className="navbar-brand flex items-center py-0 sm:py-0.5">
                <img
            ...
            <div className="nav">
              ...
              <div className="nav-links flex items-center gap-8 text-[#FCF7EE] font-light">
                <Link href="#about" passHref>
                  <a onClick={() => setChecked(toggle)}>
                    <button className="uppercase opacity-60 hover:opacity-100">
                      About
                    </button>
                  </a>
                </Link>
                ...
                <Link href="#speakersMentors" passHref>
                  <a onClick={() => setChecked(toggle)}>
                    <button className="uppercase opacity-60 hover:opacity-100">
                      Speakers
                    </button>
                ...
                <Link href="https://e7bao9msf39.typeform.com/web3week" passHref>
                  <a target="_blank">
                    <button className="bg-[#12E582] uppercase px-10 text-black-100 font-bold">
                      TALK WITH US
                    </button>
                  </a>
                </Link>
      ...
      <main className="bg-black-100 relative pb-4 sm:pb-6">
        {/* Backdrop (Gridlines) */}
        <div className="container absolute inset-y-0 inset-x-0 z-0">
        ...
        {/* Backdrop (Beams) */}
        <div className="absolute inset-y-0 inset-x-0 overflow-hidden select-none pointer-events-none -z-px">
            ...
            <section className="grid grid-cols-2 sm:grid-cols-4 gap-y-6 sm:gap-y-8 xl:gap-y-0 relative pb-10 lg:pb-[120px]">
              ...
              <div className="col-span-full xl:col-span-2 flex flex-col justify-center relative px-4">
                <div className="relative">
                  <h1 className="text-white font-w3w-bold text-2xl sm:text-3xl lg:text-[40px] lg:leading-tight font-bold uppercase pr-4 2xl:pr-15">
        ...
        <div className="overflow-hidden relative z-10">
            ...
            <div className="px-4">
              <ul className="tmline grid grid-cols-2 sm:grid-cols-6 gap-y-6 xl:gap-y-20 gap-x-0 xl:gap-x-[196px] list-none my-10 sm:my-18 lg:my-28">
                <li className="tmline-itms col-span-full sm:col-span-2">
                  <div
                    className="tmline-itms-bx flex flex-row sm:flex-col text-left sm:text-center"
                    data-aos="zoom-in"
                    data-aos-delay="200"
          ...
          <div className="container">
            ...
            <section id="speakersMentors" className="spekrsjdge px-0 sm:px-4">
            ...
            <section
              id="sponsor"
              className="grid grid-cols-4 sm:grid-cols-4 my-20 sm:my-24 lg:my-[136px] px-0 sm:px-4"
            >
              <div className="col-span-full flex flex-row items-center justify-between mb-15">
                <h1 className="text-white font-w3w-bold text-2xl sm:text-3xl lg:text-[40px] lg:leading-tight font-bold text-center uppercase">
                  Sponsor
                </h1>
                <span className="text-primary font-space-mono text-sm sm:text-xl uppercase my-auto">
                  Coming soon!
                </span>
              </div>
              <div className="col-span-full">
                <div className="grid grid-cols-12 gap-y-15">
                  <div className="col-span-6 sm:col-span-3 xl:col-span-3 flex items-center justify-center blur-lg px-4">
                    <Link href="" target="_blank" rel="noopener noreferrer">
                      <img
                        src="/assets/images/media-partner/fireblocks.svg"
                  ...
                  <div className="col-span-6 sm:col-span-3 xl:col-span-3 flex items-center justify-center blur-lg px-4">
                    <Link href="" target="_blank" rel="noopener noreferrer">
                      <img
                        src="/assets/images/media-partner/near.svg"
                        alt="Coinfest Asia 2022 (Social Media)"
                      />
                    </Link>
                  </div>
                  <div className="col-span-6 sm:col-span-3 xl:col-span-3 flex items-center justify-center blur-lg px-4">
                    <Link href="" target="_blank" rel="noopener noreferrer">
                      <img
                        src="/assets/images/media-partner/solana.svg"
                        alt="Coinfest Asia 2022 (Social Media)"
                      />
                    </Link>
                  </div>
                  <div className="col-span-6 sm:col-span-3 xl:col-span-3 flex items-center justify-center blur-lg px-4">
                    <Link href="" target="_blank" rel="noopener noreferrer">
                      <img
                        src="/assets/images/media-partner/coindesk.svg"
                        alt="Coinfest Asia 2022 (Social Media)"
                      />
                    </Link>
                  </div>
                  <div className="col-span-6 sm:col-span-3 xl:col-span-3 flex items-center justify-center blur-lg px-4">
                    <Link href="" target="_blank" rel="noopener noreferrer">
                      <img
                        src="/assets/images/media-partner/coinvestasi.svg"
                        alt="Coinfest Asia 2022 (Social Media)"
                      />
                    </Link>
                  </div>
            ...
            <section
              id="mediaPartners"
              className="grid grid-cols-4 sm:grid-cols-4 my-20 sm:my-24 lg:my-[104px] px-0 sm:px-4"
            >
              <div className="col-span-full flex flex-col sm:flex-row items-center justify-between mb-15">
                <h1 className="text-white font-w3w-bold text-2xl sm:text-3xl lg:text-[40px] lg:leading-tight font-bold text-center uppercase">
                  Media Partners
                </h1>
                <span className="text-primary font-space-mono text-sm sm:text-xl uppercase mt-2 mb-auto sm:my-auto">
                  Coming soon!
                </span>
              </div>
              <div className="col-span-full">
                <div className="grid grid-cols-12 gap-y-15">
                  <div className="col-span-6 sm:col-span-3 xl:col-span-2 flex items-center justify-center px-4">
                    <Link href="" target="_blank" rel="noopener noreferrer">
                      <img
                        src="/assets/images/media-partner/fireblocks.svg"
                        alt="Coinfest Asia 2022 (Social Media)"
              ...
              <div className="col-span-full grid grid-cols-12 gap-y-4 sm:gap-y-6 xl:gap-y-8 gap-x-0 sm:gap-x-6 xl:gap-x-8 mt-6 sm:mt-8">
                <div className="col-span-full sm:col-span-6 lg:col-span-4 xl:col-span-4 grayscale hover:grayscale-0 transition duration-500 ease-in-out">
                  <Link
                    ...
                    rel="noopener noreferrer"
                  >
                    <a className="bx bg-grdients-black flex flex-col items-center justify-center px-4">
                      <img
            ...
            <section className="bnner bnner-backdrop bnner-in relative mx-0 sm:mx-4">
              ...
              <div className="bnner-in-content grid gap-y-3 sm:gap-y-4 relative z-50">
                ...
                <Link
                  ...
                  rel="noopener noreferrer"
                >
                  <a className="btn btn-outline-white bg-white/40 btn-sm sm:btn-base btn-square uppercase mx-auto">
                    START BUILDING NOW
                  </a>
                </Link>
              </div>
