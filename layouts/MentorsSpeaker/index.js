      ...
      >
        ...
        >
          <div className="col-span-4 lg:col-span-2 px-2">
            <article className="supports-grid:grid gap-y-6 text-center blur-sm">
              <div>
                <div className="bg-gray-100 flex items-center justify-center mx-auto px-4 h-[152px] w-[152px]"></div>
              </div>
              <div className="flex flex-col">
                <h2 className="text-white font-w3w-bold text-xl uppercase">
                  Title
                </h2>
...
export default LyMentorsSpeaker;
